...
function output_csv_header() {
    echo "SUBSCRIPTION_NAME,SUBSCRIPTION_STATE,SUBSCRIPTION_ID,RESOURCE_GROUP_NAME,REDIS_CACHE_NAME,REDIS_CACHE_LOCATION,REDIS_CACHE_SUBNET_ID,REDIS_CACHE_IS_VNET_INJECTED,REDIS_CACHE_PRIVATE_ENDPOINTS,REDIS_CACHE_HAS_PRIVATE_ENDPOINT,REDIS_CACHE_PUBLIC_NETWORK_ACCESS,REDIS_CACHE_PUBLIC_NETWORK_ACCESS_VIOLATION_FLAG"
}
...
function output_redis_list_text() {
    ...
    echo "Azure Cache Redis Public Network Access: $REDIS_CACHE_PUBLIC_NETWORK_ACCESS"
