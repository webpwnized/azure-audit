...
# Debug: ./cis-10.3.2.3-ensure-default-network-access-storage-accounts-set-deny.sh -s SUBSCRIPTION_ID -r RESOURCE_NAME --debug
...
function output_csv_header() {
    ...
    echo "SUBSCRIPTION_NAME,SUBSCRIPTION_STATE,SUBSCRIPTION_ID,RESOURCE_GROUP_NAME,STORAGE_ACCOUNT_NAME,STORAGE_ACCOUNT_DEFAULT_NETWORK_ACCESS_RULE,STORAGE_ACCOUNT_DEFAULT_NETWORK_ACCESS_RULE_VIOLATION_FLAG"
}
